...
namespace Statusbits
{
  ...
  public partial class MainWindow : Window
  {
    ...
    private void V1600_OnClick(object sender, RoutedEventArgs e)
    {
      if (controller.Model.Version != "1600")
      {
        string value = BinaryTB.Text;
        controller.UpdateStatusbitsFromVersion("1600");
        controller.UpdateValues(value, controller.Model.Bin_Resources, ActiveBits8.SelectedItems, ActiveBits7.SelectedItems, ActiveBits6.SelectedItems, ActiveBits5.SelectedItems, ActiveBits4.SelectedItems, ActiveBits3.SelectedItems, ActiveBits2.SelectedItems, ActiveBits1.SelectedItems); ;
      }
    }

    private void V1500_OnClick(object sender, RoutedEventArgs e)
    {
      if (controller.Model.Version != "1500")
      {
        string value = BinaryTB.Text;
        controller.UpdateStatusbitsFromVersion("1500");
        controller.UpdateValues(value, controller.Model.Bin_Resources, ActiveBits8.SelectedItems, ActiveBits7.SelectedItems, ActiveBits6.SelectedItems, ActiveBits5.SelectedItems, ActiveBits4.SelectedItems, ActiveBits3.SelectedItems, ActiveBits2.SelectedItems, ActiveBits1.SelectedItems); ;
      }
    }

    private void V1400_OnClick(object sender, RoutedEventArgs e)
    {
      if (controller.Model.Version != "1400")
      {
        string value = BinaryTB.Text;
        controller.UpdateStatusbitsFromVersion("1400");
        controller.UpdateValues(value, controller.Model.Bin_Resources, ActiveBits8.SelectedItems, ActiveBits7.SelectedItems, ActiveBits6.SelectedItems, ActiveBits5.SelectedItems, ActiveBits4.SelectedItems, ActiveBits3.SelectedItems, ActiveBits2.SelectedItems, ActiveBits1.SelectedItems); ;
      }
    }
    private void V1200_OnClick(object sender, RoutedEventArgs e)
    {
      if (controller.Model.Version != "1200")
      {
        string value = BinaryTB.Text;
        controller.UpdateStatusbitsFromVersion("1200");
        controller.UpdateValues(value, controller.Model.Bin_Resources, ActiveBits8.SelectedItems, ActiveBits7.SelectedItems, ActiveBits6.SelectedItems, ActiveBits5.SelectedItems, ActiveBits4.SelectedItems, ActiveBits3.SelectedItems, ActiveBits2.SelectedItems, ActiveBits1.SelectedItems); ;
      }
    }

    private void V1100_OnClick(object sender, RoutedEventArgs e)
    {
      if (controller.Model.Version != "1100")
      {
        string value = BinaryTB.Text;
        controller.UpdateStatusbitsFromVersion("1100");
        controller.UpdateValues(value, controller.Model.Bin_Resources, ActiveBits8.SelectedItems, ActiveBits7.SelectedItems, ActiveBits6.SelectedItems, ActiveBits5.SelectedItems, ActiveBits4.SelectedItems, ActiveBits3.SelectedItems, ActiveBits2.SelectedItems, ActiveBits1.SelectedItems); ;
      }
    }
